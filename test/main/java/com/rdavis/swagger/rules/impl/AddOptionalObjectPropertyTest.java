...
public class AddOptionalObjectPropertyTest {
    ...
    public void setup() throws Exception {
        File file = new File(getClass().getClassLoader().getResource("swaggerAddOptionalObjectProperty.json").toURI());
    ...
    public void testSetBreakingChange() throws Exception {
        AddOptionalObjectProperty addOptionalObjectProperty = new AddOptionalObjectProperty();
        boolean defaultValue = addOptionalObjectProperty.isBreakingChange();
        addOptionalObjectProperty.setBreakingChange(true);
        boolean newValue = addOptionalObjectProperty.isBreakingChange();
        assertNotEquals(defaultValue, newValue);
    }

    @Test
    public void testIsBreakingChange() throws Exception {
        assertEquals(new AddOptionalObjectProperty().isBreakingChange(), false);
    }

    @Test
    public void testGetRuleName() throws Exception {
        String ruleName = CaseFormat.UPPER_CAMEL.to(CaseFormat.LOWER_UNDERSCORE, AddOptionalObjectProperty.class.getSimpleName());
        assertEquals(new AddOptionalObjectProperty().getRuleName(), ruleName);
    }
