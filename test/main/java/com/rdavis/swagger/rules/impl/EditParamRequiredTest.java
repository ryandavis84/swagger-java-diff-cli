...
public class EditParamRequiredTest {
    private Swagger swagger;
    private Swagger swaggerDeployed;

    @BeforeClass
    public void setup() throws Exception {
        File file = new File(getClass().getClassLoader().getResource("swaggerEditParamRequired.json").toURI());
    ...
    public void testSetBreakingChange() throws Exception {
        EditParamRequired editParamRequired = new EditParamRequired();
        boolean defaultValue = editParamRequired.isBreakingChange();
        editParamRequired.setBreakingChange(false);
        boolean newValue = editParamRequired.isBreakingChange();
        assertNotEquals(defaultValue, newValue);
    }

    @Test
    public void testIsBreakingChange() throws Exception {
        assertEquals(new EditParamRequired().isBreakingChange(), true);
    }

    @Test
    public void testGetRuleName() throws Exception {
        String ruleName = CaseFormat.UPPER_CAMEL.to(CaseFormat.LOWER_UNDERSCORE, EditParamRequired.class.getSimpleName());
        assertEquals(new EditParamRequired().getRuleName(), ruleName);
    }

    @Test
    public void testValidateBreakingOn() throws Exception {
        EditParamRequired addOptionalObjectProperty = new EditParamRequired();
