...
public class EditObjectPropertyRequired implements RuleV2 {
                ...
                if (modelEntry.getValue().getProperties() != null) {
                    for (Map.Entry<String, Property> propertyEntry : modelEntry.getValue().getProperties().entrySet()) {
                        if (deployedSwagger.getDefinitions() != null &&
                                ...
                                deployedSwagger.getDefinitions().get(modelEntry.getKey()).getProperties().get(propertyEntry.getKey()).getRequired() != propertyEntry.getValue().getRequired()) {
